...
class CDenoiserTonemapperBuilder extends IBuilder
{
	public CDenoiserTonemapperBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new CDenoiserTonemapperBuilder(_agent, _info)
}
