...
class COrderIndependentTransparencyBuilder extends IBuilder
{
	public COrderIndependentTransparencyBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new COrderIndependentTransparencyBuilder(_agent, _info)
}
