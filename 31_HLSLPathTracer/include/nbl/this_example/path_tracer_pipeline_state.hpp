...
using cached_pipeline_storage_traits_t = examples::common::SRenderPipelineStorage<ELG_COUNT, EPM_COUNT, 2ull>;
...
using SRenderPipelineStorage = examples::common::SRenderPipelineStorage<ELG_COUNT, EPM_COUNT, BinaryToggleCount>;
