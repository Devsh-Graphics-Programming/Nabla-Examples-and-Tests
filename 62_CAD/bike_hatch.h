...
CPolyline polyline;
{
    std::vector<QuadraticBezierInfo> quadraticBeziers;
    quadraticBeziers.push_back({ { float64_t2(97.93187369058725, 19.166666669426142), float64_t2(98.39675081804235, 19.166666669426142), float64_t2(98.8276811965705, 19.38979268349983) } });
    ...
    polyline.addQuadBeziers(core::SRange<QuadraticBezierInfo>(quadraticBeziers.data(), quadraticBeziers.data() + quadraticBeziers.size()));
}
{
    std::vector<QuadraticBezierInfo> quadraticBeziers;
...
CPolyline polyline;
{
    ...
    quadraticBeziers.push_back({ { float64_t2(55.24570747771344, 30.462017255248846), float64_t2(56.499323120174495, 31.111111112490846), float64_t2(57.85169294647871, 31.111111112490846) } });
    ...
    quadraticBeziers.push_back({ { float64_t2(51.47826312751328, 18.685208709427602), float64_t2(52.02763921514359, 17.064541843892247), float64_t2(53.0195895158084, 15.83581097699978) } });
    quadraticBeziers.push_back({ { float64_t2(53.0195895158084, 15.83581097699978), float64_t2(53.99160539687126, 14.631772917453889), float64_t2(55.24570747771344, 13.982427196094282) } });
    quadraticBeziers.push_back({ { float64_t2(55.24570747771344, 13.982427196094282), float64_t2(56.499323120174495, 13.333333338852283), float64_t2(57.85169294647871, 13.333333338852283) } });
    polyline.addQuadBeziers(core::SRange<QuadraticBezierInfo>(quadraticBeziers.data(), quadraticBeziers.data() + quadraticBeziers.size()));
}
{
    std::vector<QuadraticBezierInfo> quadraticBeziers;
    quadraticBeziers.push_back({ { float64_t2(57.85169294647871, 13.333333331953595), float64_t2(59.204062772782926, 13.333333331953595), float64_t2(60.45767842063564, 13.982427185746255) } });
    quadraticBeziers.push_back({ { float64_t2(60.45767842063564, 13.982427185746255), float64_t2(61.71178050147782, 14.631772910555204), float64_t2(62.6837963852365, 15.835810970101091) } });
...
{
    std::vector<float64_t2> linePoints;
    linePoints.push_back({ 57.85169294647871, 31.111111112490846 });
    polyline.addLinePoints(core::SRange<float64_t2>(linePoints.data(), linePoints.data() + linePoints.size()));
}
polylines.push_back(polyline);
}
...
}
{
    ...
    quadraticBeziers.push_back({ { float64_t2(84.64572918977726, 91.66666665631864), float64_t2(84.81477541671737, 91.66666665976798), float64_t2(84.97147737303594, 91.58552993019974) } });
...
}
{
    ...
    quadraticBeziers.push_back({ { float64_t2(20.45658743899278, 91.54496155679226), float64_t2(20.691640370774806, 91.6666666528693), float64_t2(20.94520971253289, 91.6666666528693) } });
...
}
{
    ...
    quadraticBeziers.push_back({ { float64_t2(12.775085171011217, 86.62873713506592), float64_t2(13.682471008207314, 84.64053057617059), float64_t2(15.230112077903394, 83.46595537883265) } });
    polyline.addQuadBeziers(core::SRange<QuadraticBezierInfo>(quadraticBeziers.data(), quadraticBeziers.data() + quadraticBeziers.size()));
}
{
    std::vector<float64_t2> linePoints;
...
}
{
    ...
    quadraticBeziers.push_back({ { float64_t2(56.10912287718125, 8.51346746225048), float64_t2(58.601381647986905, 7.99481924623251), float64_t2(61.01667373080921, 8.936825353238318) } });
    polyline.addQuadBeziers(core::SRange<QuadraticBezierInfo>(quadraticBeziers.data(), quadraticBeziers.data() + quadraticBeziers.size()));
}
{
    std::vector<float64_t2> linePoints;
...
}
{
    ...
    quadraticBeziers.push_back({ { float64_t2(-0.8662337583329167, 23.851594035686166), float64_t2(-0.5480010468493852, 24.578297952259028), float64_t2(2.6958306655248165e-09, 25.02802261668775) } });
