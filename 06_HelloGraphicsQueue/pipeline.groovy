...
class CHelloGraphicsQueueBuilder extends IBuilder
{
	public CHelloGraphicsQueueBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new CHelloGraphicsQueueBuilder(_agent, _info)
}
