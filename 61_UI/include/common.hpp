...
using nbl::hlsl::CCameraSequenceScriptedSegmentBuildInfo;
using nbl::hlsl::CCameraScriptedInputEvent;
using nbl::hlsl::CCameraScriptedInputCheck;
using nbl::hlsl::CCameraScriptedFrameEvents;
using nbl::hlsl::CCameraScriptedTimeline;
using nbl::hlsl::CCameraScriptedControlOverrides;
using nbl::hlsl::CCameraScriptedInputParseResult;
using nbl::hlsl::CCameraScriptedCheckContext;
using nbl::hlsl::CCameraScriptedCheckFrameResult;
using nbl::hlsl::CCameraScriptedCheckLogEntry;
using nbl::hlsl::CCameraScriptedCheckRuntimeState;
...
using nbl::hlsl::SCameraFollowVisualMetrics;
