...
using nbl::ext::cameras::CCameraGoal;
using nbl::ext::cameras::CTrackedTarget;
using nbl::ext::cameras::CCameraPreset;
using nbl::ext::cameras::CCameraKeyframe;
using nbl::ext::cameras::CCameraKeyframeTrack;
using nbl::ext::cameras::CCameraPlaybackCursor;
using nbl::ext::cameras::CCameraSequenceScript;
using nbl::ext::cameras::CCameraSequenceSegment;
using nbl::ext::cameras::CCameraSequenceKeyframe;
using nbl::ext::cameras::CCameraSequenceTrackedTargetPose;
using nbl::ext::cameras::CCameraSequenceTrackedTargetTrack;
using nbl::ext::cameras::CCameraSequencePresentation;
using nbl::ext::cameras::CCameraSequenceContinuitySettings;
using nbl::ext::cameras::CCameraScriptedInputEvent;
using nbl::ext::cameras::CCameraScriptedInputCheck;
using nbl::ext::cameras::CCameraScriptedFrameEvents;
using nbl::ext::cameras::CCameraScriptedTimeline;
using nbl::ext::cameras::CCameraScriptedCheckContext;
using nbl::ext::cameras::CCameraScriptedCheckFrameResult;
using nbl::ext::cameras::CCameraScriptedCheckLogEntry;
using nbl::ext::cameras::CCameraScriptedCheckRuntimeState;
using nbl::ext::cameras::SCameraPlaybackAdvanceResult;
using nbl::ext::cameras::SCameraPresetApplySummary;
using nbl::ext::cameras::SCameraGoalApplyAnalysis;
using nbl::ext::cameras::SCameraCaptureAnalysis;
using nbl::ext::cameras::SCameraFollowConfig;
using nbl::ext::cameras::SCameraFollowVisualMetrics;
using nbl::ext::cameras::SCameraGoalApplyPresentation;
using nbl::ext::cameras::SCameraGoalApplyPresentationBadges;
using nbl::ext::cameras::SCameraCapturePresentation;
...
using nbl::ext::cameras::CCameraGoalSolver;
using nbl::ext::cameras::ECameraFollowMode;
using nbl::ext::cameras::EPresetApplyPresentationFilter;
