...
using nbl::core::describeApplyResult;
using nbl::core::describeGoalStateMask;
using nbl::core::getCameraFollowModeLabel;
using nbl::core::getCameraTypeDescription;
using nbl::core::getCameraTypeLabel;
...
using nbl::core::cameraFollowModeUsesLocalOffset;
using nbl::core::cameraFollowModeUsesWorldOffset;
