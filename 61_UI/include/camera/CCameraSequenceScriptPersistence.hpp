...
static bool deserializeSequenceKeyframeJson(const json_t& root, CCameraSequenceKeyframe& out, std::string* error)
{
    ...
    {
        camera_json_impl::CCameraJsonPersistenceUtilities::deserializePresetJson(root["preset"], out.absolutePreset);
    ...
    {
        camera_json_impl::CCameraJsonPersistenceUtilities::deserializePresetJson(root, out.absolutePreset);
        out.hasAbsolutePreset = true;
    }
...
inline bool CCameraSequenceScriptPersistenceUtilities::deserializeCameraSequenceScript(std::string_view text, CCameraSequenceScript& out, std::string* error)
{
    try
    {
        const auto root = json_t::parse(text);
        return camera_json_impl::CCameraSequenceScriptJsonUtilities::deserializeCameraSequenceScriptJson(root, out, error);
    }
...
inline bool CCameraSequenceScriptPersistenceUtilities::loadCameraSequenceScriptFromFile(system::ISystem& system, const system::path& filePath, CCameraSequenceScript& out, std::string* error)
{
    std::string text;
