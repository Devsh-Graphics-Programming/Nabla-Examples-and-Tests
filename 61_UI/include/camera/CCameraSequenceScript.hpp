...
inline bool CCameraSequenceScriptUtilities::tryParseCameraKind(std::string_view value, ICamera::CameraKind& outKind)
{
    if (value == "FPS")
...
inline void CCameraSequenceScriptUtilities::normalizeCaptureFractions(std::vector<float>& fractions)
{
...
inline bool CCameraSequenceScriptUtilities::buildSequenceKeyframePreset(const CCameraPreset& reference, const CCameraSequenceKeyframe& authored, CCameraPreset& outPreset, std::string* error)
{
...
inline bool CCameraSequenceScriptUtilities::buildSequenceTrackFromReference(const CCameraPreset& reference, const CCameraSequenceSegment& segment, CCameraKeyframeTrack& outTrack, std::string* error)
{
    outTrack = {};
...
inline bool CCameraSequenceScriptUtilities::isSequenceTrackedTargetPoseFinite(const CCameraSequenceTrackedTargetPose& pose)
{
    return CCameraMathUtilities::isFiniteVec3(pose.position) &&
        CCameraMathUtilities::isFiniteQuaternion(pose.orientation);
}

inline bool CCameraSequenceScriptUtilities::buildSequenceTrackedTargetPoseFromReference(
    const CCameraSequenceTrackedTargetPose& reference,
    const CCameraSequenceTrackedTargetKeyframe& authored,
    CCameraSequenceTrackedTargetPose& outPose,
    std::string* error)
...
inline bool CCameraSequenceScriptUtilities::buildSequenceTrackedTargetTrackFromReference(
    const CCameraSequenceTrackedTargetPose& reference,
    const CCameraSequenceSegment& segment,
    CCameraSequenceTrackedTargetTrack& outTrack,
    std::string* error)
...
inline bool CCameraSequenceScriptUtilities::tryBuildSequenceTrackedTargetPoseAtTime(
    const CCameraSequenceTrackedTargetTrack& track,
    const float time,
    CCameraSequenceTrackedTargetPose& outPose)
{
...
inline bool CCameraSequenceScriptUtilities::sequenceSegmentUsesTrackedTargetTrack(const CCameraSequenceSegment& segment)
{
    return !segment.targetKeyframes.empty();
}

inline float CCameraSequenceScriptUtilities::getSequenceSegmentDurationSeconds(const CCameraSequenceScript& script, const CCameraSequenceSegment& segment, const CCameraKeyframeTrack* track)
{
...
inline const std::vector<CCameraSequencePresentation>& CCameraSequenceScriptUtilities::getSequenceSegmentPresentations(const CCameraSequenceScript& script, const CCameraSequenceSegment& segment)
{
    return segment.presentations.empty() ? script.defaults.presentations : segment.presentations;
}

inline CCameraSequenceContinuitySettings CCameraSequenceScriptUtilities::getSequenceSegmentContinuity(const CCameraSequenceScript& script, const CCameraSequenceSegment& segment)
{
    return segment.hasContinuity ? segment.continuity : script.defaults.continuity;
}

inline std::vector<float> CCameraSequenceScriptUtilities::getSequenceSegmentCaptureFractions(const CCameraSequenceScript& script, const CCameraSequenceSegment& segment)
{
...
inline bool CCameraSequenceScriptUtilities::getSequenceSegmentResetCamera(const CCameraSequenceScript& script, const CCameraSequenceSegment& segment)
{
    return segment.hasResetCamera ? segment.resetCamera : script.defaults.resetCamera;
}

inline bool CCameraSequenceScriptUtilities::sequenceScriptUsesMultiplePresentations(const CCameraSequenceScript& script)
{
...
inline uint64_t CCameraSequenceScriptUtilities::buildSequenceDurationFrames(const float durationSeconds, const float fps)
{
...
inline void CCameraSequenceScriptUtilities::buildSequenceSampleTimes(const float durationSeconds, const uint64_t durationFrames, std::vector<float>& outTimes)
{
    outTimes.clear();
...
inline void CCameraSequenceScriptUtilities::buildSequenceCaptureFrameOffsets(
...
inline bool CCameraSequenceScriptUtilities::compileSequenceSegmentFromReference(
    const CCameraSequenceScript& script,
    const CCameraSequenceSegment& segment,
    const CCameraPreset& referencePreset,
    const CCameraSequenceTrackedTargetPose& referenceTrackedTargetPose,
...
inline bool CCameraSequenceScriptUtilities::buildCompiledSegmentFramePolicies(
    const CCameraSequenceCompiledSegment& segment,
    std::vector<CCameraSequenceCompiledFramePolicy>& outPolicies,
