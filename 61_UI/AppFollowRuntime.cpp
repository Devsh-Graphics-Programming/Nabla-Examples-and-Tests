...
quaternion<float64_t> App::getDefaultFollowTargetOrientation() const
{
...
{
	const auto modelTransform = hlsl::transpose(hlsl::math::linalg::promote_affine<4,4,3,4>(m_sceneInteraction.model));
