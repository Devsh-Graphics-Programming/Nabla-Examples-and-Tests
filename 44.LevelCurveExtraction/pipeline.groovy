...
class CLevelCurveExtractionBuilder extends IBuilder
{
	public CLevelCurveExtractionBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new CLevelCurveExtractionBuilder(_agent, _info)
}
