...
void main(uint3 invocationID : SV_DispatchThreadID)
{
  ...
  //   break;
  // case BM_POLYNOMIAL0:
  //   output = integrate_edge<BM_POLYNOMIAL0>(invocationID.x);
  //   break;
  // case BM_POLYNOMIAL1:
  //   output = integrate_edge<BM_POLYNOMIAL1>(invocationID.x);
  //   break;
  // case BM_POLYNOMIAL_ORDER3:
  //   output = integrate_edge<BM_POLYNOMIAL_ORDER3>(invocationID.x);
  //   break;
  // case BM_AGATHA:
  //   output = integrate_edge<BM_AGATHA>(invocationID.x);
  //   break;
  // }
