...
public:
    ...
    CDollyCamera(const float64_t3& position, const float64_t3& target)
    ...
    virtual const std::string_view getIdentifier() override { return "Dolly Camera"; }

private:
    static inline constexpr auto AllowedVirtualEvents = CVirtualGimbalEvent::Translate | CVirtualGimbalEvent::Rotate;
    static inline constexpr double MaxPitch = glm::radians(85.0);
    static inline constexpr double MinPitch = glm::radians(-85.0);
