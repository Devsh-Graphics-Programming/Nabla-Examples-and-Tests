...
class CImportanceSamplingEnvMapsBuilder extends IBuilder
{
	public CImportanceSamplingEnvMapsBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new CImportanceSamplingEnvMapsBuilder(_agent, _info)
}
