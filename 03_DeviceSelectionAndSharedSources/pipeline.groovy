...
class CDeviceSelectionAndSharedSourcesBuilder extends IBuilder
{
	public CDeviceSelectionAndSharedSourcesBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new CDeviceSelectionAndSharedSourcesBuilder(_agent, _info)
}
