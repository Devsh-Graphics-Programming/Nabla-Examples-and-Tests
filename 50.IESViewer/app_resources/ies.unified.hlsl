...
// TODO: need better common headers
...
[[vk::binding(0, 1)]] Buffer<float32_t4> utbs[SPushConstants::DescriptorCount];
...
// TODO: should be shared, duplicated code
...
{
    float32_t2 uv = iesDirToUv(input.latDir);
    float32_t candela = inIESCandelaImage[pc.texID].Sample(generalSampler, uv).r;
