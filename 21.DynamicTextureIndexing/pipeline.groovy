...
class CDynamicTextureIndexingBuilder extends IBuilder
{
	public CDynamicTextureIndexingBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new CDynamicTextureIndexingBuilder(_agent, _info)
}
