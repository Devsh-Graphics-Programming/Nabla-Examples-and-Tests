...
class CSamplingValidationBuilder extends IBuilder
{
	public CSamplingValidationBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new CSamplingValidationBuilder(_agent, _info)
}
