...
APP_CONSTRUCTOR(PLYSTLDemo)
	...
	void onAppInitialized_impl() override
	{
		...
		CommonAPI::InitWithDefaultExt(initOutput, video::EAT_VULKAN/*Vulkan doesn't work yet*/, "plystldemo", WIN_W, WIN_H, SC_IMG_COUNT, swapchainImageUsage, surfaceFormat, nbl::asset::EF_D32_SFLOAT);
