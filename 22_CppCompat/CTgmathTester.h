...
private:
    ...
    void verifyTestResults(const TgmathTestValues& expectedTestValues, const TgmathTestValues& testValues, const size_t testIteration, const uint32_t seed, TestType testType) override
    {
        ...
        verifyTestValue("log2", expectedTestValues.log2, testValues.log2, testIteration, seed, testType);
        verifyTestValue("absF", expectedTestValues.absF, testValues.absF, testIteration, seed, testType);
        verifyTestValue("absI", expectedTestValues.absI, testValues.absI, testIteration, seed, testType);
        verifyTestValue("sqrt", expectedTestValues.sqrt, testValues.sqrt, testIteration, seed, testType);
        verifyTestValue("sin", expectedTestValues.sin, testValues.sin, testIteration, seed, testType);
        verifyTestValue("cos", expectedTestValues.cos, testValues.cos, testIteration, seed, testType);
        verifyTestValue("acos", expectedTestValues.acos, testValues.acos, testIteration, seed, testType);
        verifyTestValue("tan", expectedTestValues.tan, testValues.tan, testIteration, seed, testType);
        verifyTestValue("asin", expectedTestValues.asin, testValues.asin, testIteration, seed, testType);
        verifyTestValue("atan", expectedTestValues.atan, testValues.atan, testIteration, seed, testType);
        //verifyTestValue("sinh", expectedTestValues.sinh, testValues.sinh, testIteration, seed, testType);
        //verifyTestValue("cosh", expectedTestValues.cosh, testValues.cosh, testIteration, seed, testType);
        verifyTestValue("tanh", expectedTestValues.tanh, testValues.tanh, testIteration, seed, testType);
        verifyTestValue("asinh", expectedTestValues.asinh, testValues.asinh, testIteration, seed, testType);
        verifyTestValue("acosh", expectedTestValues.acosh, testValues.acosh, testIteration, seed, testType);
        verifyTestValue("atanh", expectedTestValues.atanh, testValues.atanh, testIteration, seed, testType);
        verifyTestValue("atan2", expectedTestValues.atan2, testValues.atan2, testIteration, seed, testType);
        verifyTestValue("modf", expectedTestValues.modf, testValues.modf, testIteration, seed, testType);
        verifyTestValue("round", expectedTestValues.round, testValues.round, testIteration, seed, testType);
        verifyTestValue("roundEven", expectedTestValues.roundEven, testValues.roundEven, testIteration, seed, testType);
        verifyTestValue("trunc", expectedTestValues.trunc, testValues.trunc, testIteration, seed, testType);
        verifyTestValue("ceil", expectedTestValues.ceil, testValues.ceil, testIteration, seed, testType);
        verifyTestValue("fma", expectedTestValues.fma, testValues.fma, testIteration, seed, testType);
        verifyTestValue("ldexp", expectedTestValues.ldexp, testValues.ldexp, testIteration, seed, testType);
        verifyTestValue("erf", expectedTestValues.erf, testValues.erf, testIteration, seed, testType);
        //verifyTestValue("erfInv", expectedTestValues.erfInv, testValues.erfInv, testIteration, seed, testType);
        ...
        verifyTestValue("log2Vec", expectedTestValues.log2Vec, testValues.log2Vec, testIteration, seed, testType);
        verifyTestValue("absFVec", expectedTestValues.absFVec, testValues.absFVec, testIteration, seed, testType);
        verifyTestValue("absIVec", expectedTestValues.absIVec, testValues.absIVec, testIteration, seed, testType);
        verifyTestValue("sqrtVec", expectedTestValues.sqrtVec, testValues.sqrtVec, testIteration, seed, testType);
        verifyTestValue("sinVec", expectedTestValues.sinVec, testValues.sinVec, testIteration, seed, testType);
        verifyTestValue("cosVec", expectedTestValues.cosVec, testValues.cosVec, testIteration, seed, testType);
        verifyTestValue("acosVec", expectedTestValues.acosVec, testValues.acosVec, testIteration, seed, testType);
        verifyTestValue("modfVec", expectedTestValues.modfVec, testValues.modfVec, testIteration, seed, testType);
        verifyTestValue("roundVec", expectedTestValues.roundVec, testValues.roundVec, testIteration, seed, testType);
        verifyTestValue("roundEvenVec", expectedTestValues.roundEvenVec, testValues.roundEvenVec, testIteration, seed, testType);
        verifyTestValue("truncVec", expectedTestValues.truncVec, testValues.truncVec, testIteration, seed, testType);
        verifyTestValue("ceilVec", expectedTestValues.ceilVec, testValues.ceilVec, testIteration, seed, testType);
        verifyTestValue("fmaVec", expectedTestValues.fmaVec, testValues.fmaVec, testIteration, seed, testType);
        verifyTestValue("ldexp", expectedTestValues.ldexpVec, testValues.ldexpVec, testIteration, seed, testType);
        verifyTestValue("tanVec", expectedTestValues.tanVec, testValues.tanVec, testIteration, seed, testType);
        verifyTestValue("asinVec", expectedTestValues.asinVec, testValues.asinVec, testIteration, seed, testType);
        verifyTestValue("atanVec", expectedTestValues.atanVec, testValues.atanVec, testIteration, seed, testType);
        //verifyTestValue("sinhVec", expectedTestValues.sinhVec, testValues.sinhVec, testIteration, seed, testType);
        //verifyTestValue("coshVec", expectedTestValues.coshVec, testValues.coshVec, testIteration, seed, testType);
        verifyTestValue("tanhVec", expectedTestValues.tanhVec, testValues.tanhVec, testIteration, seed, testType);
        verifyTestValue("asinhVec", expectedTestValues.asinhVec, testValues.asinhVec, testIteration, seed, testType);
        verifyTestValue("acoshVec", expectedTestValues.acoshVec, testValues.acoshVec, testIteration, seed, testType);
        verifyTestValue("atanhVec", expectedTestValues.atanhVec, testValues.atanhVec, testIteration, seed, testType);
        verifyTestValue("atan2Vec", expectedTestValues.atan2Vec, testValues.atan2Vec, testIteration, seed, testType);
        verifyTestValue("erfVec", expectedTestValues.erfVec, testValues.erfVec, testIteration, seed, testType);
        //verifyTestValue("erfInvVec", expectedTestValues.erfInvVec, testValues.erfInvVec, testIteration, seed, testType);

        // verify output of struct producing functions
        verifyTestValue("modfStruct", expectedTestValues.modfStruct.fractionalPart, testValues.modfStruct.fractionalPart, testIteration, seed, testType);
        verifyTestValue("modfStruct", expectedTestValues.modfStruct.wholeNumberPart, testValues.modfStruct.wholeNumberPart, testIteration, seed, testType);
        verifyTestValue("modfStructVec", expectedTestValues.modfStructVec.fractionalPart, testValues.modfStructVec.fractionalPart, testIteration, seed, testType);
        verifyTestValue("modfStructVec", expectedTestValues.modfStructVec.wholeNumberPart, testValues.modfStructVec.wholeNumberPart, testIteration, seed, testType);

        verifyTestValue("frexpStruct", expectedTestValues.frexpStruct.significand, testValues.frexpStruct.significand, testIteration, seed, testType);
        verifyTestValue("frexpStruct", expectedTestValues.frexpStruct.exponent, testValues.frexpStruct.exponent, testIteration, seed, testType);
        verifyTestValue("frexpStructVec", expectedTestValues.frexpStructVec.significand, testValues.frexpStructVec.significand, testIteration, seed, testType);
        verifyTestValue("frexpStructVec", expectedTestValues.frexpStructVec.exponent, testValues.frexpStructVec.exponent, testIteration, seed, testType);
    }
};
