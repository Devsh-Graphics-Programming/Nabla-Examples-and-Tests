...
private:
    ...
    bool verifyTestResults(const TgmathTestValues& expectedTestValues, const TgmathTestValues& testValues, const size_t testIteration, const uint32_t seed, TestType testType) override
    {
        ...
        bool pass = true;
        pass = verifyTestValue("floor", expectedTestValues.floor, testValues.floor, testIteration, seed, testType) && pass;
        pass = verifyTestValue("isnan", expectedTestValues.isnan, testValues.isnan, testIteration, seed, testType) && pass;
        pass = verifyTestValue("isinf", expectedTestValues.isinf, testValues.isinf, testIteration, seed, testType) && pass;
        pass = verifyTestValue("pow", expectedTestValues.pow, testValues.pow, testIteration, seed, testType, 0.0001) && pass;
        pass = verifyTestValue("exp", expectedTestValues.exp, testValues.exp, testIteration, seed, testType) && pass;
        pass = verifyTestValue("exp2", expectedTestValues.exp2, testValues.exp2, testIteration, seed, testType) && pass;
        pass = verifyTestValue("log", expectedTestValues.log, testValues.log, testIteration, seed, testType) && pass;
        pass = verifyTestValue("log2", expectedTestValues.log2, testValues.log2, testIteration, seed, testType) && pass;
        pass = verifyTestValue("absF", expectedTestValues.absF, testValues.absF, testIteration, seed, testType) && pass;
        pass = verifyTestValue("absI", expectedTestValues.absI, testValues.absI, testIteration, seed, testType) && pass;
        pass = verifyTestValue("sqrt", expectedTestValues.sqrt, testValues.sqrt, testIteration, seed, testType) && pass;
        pass = verifyTestValue("sin", expectedTestValues.sin, testValues.sin, testIteration, seed, testType) && pass;
        pass = verifyTestValue("cos", expectedTestValues.cos, testValues.cos, testIteration, seed, testType) && pass;
        pass = verifyTestValue("acos", expectedTestValues.acos, testValues.acos, testIteration, seed, testType) && pass;
        pass = verifyTestValue("tan", expectedTestValues.tan, testValues.tan, testIteration, seed, testType) && pass;
        pass = verifyTestValue("asin", expectedTestValues.asin, testValues.asin, testIteration, seed, testType) && pass;
        pass = verifyTestValue("atan", expectedTestValues.atan, testValues.atan, testIteration, seed, testType) && pass;
        //pass = verifyTestValue("sinh", expectedTestValues.sinh, testValues.sinh, testIteration, seed, testType) && pass;
        //pass = verifyTestValue("cosh", expectedTestValues.cosh, testValues.cosh, testIteration, seed, testType) && pass;
        pass = verifyTestValue("tanh", expectedTestValues.tanh, testValues.tanh, testIteration, seed, testType) && pass;
        pass = verifyTestValue("asinh", expectedTestValues.asinh, testValues.asinh, testIteration, seed, testType) && pass;
        pass = verifyTestValue("acosh", expectedTestValues.acosh, testValues.acosh, testIteration, seed, testType) && pass;
        pass = verifyTestValue("atanh", expectedTestValues.atanh, testValues.atanh, testIteration, seed, testType) && pass;
        pass = verifyTestValue("atan2", expectedTestValues.atan2, testValues.atan2, testIteration, seed, testType) && pass;
        pass = verifyTestValue("modf", expectedTestValues.modf, testValues.modf, testIteration, seed, testType) && pass;
        pass = verifyTestValue("round", expectedTestValues.round, testValues.round, testIteration, seed, testType) && pass;
        pass = verifyTestValue("roundEven", expectedTestValues.roundEven, testValues.roundEven, testIteration, seed, testType) && pass;
        pass = verifyTestValue("trunc", expectedTestValues.trunc, testValues.trunc, testIteration, seed, testType) && pass;
        pass = verifyTestValue("ceil", expectedTestValues.ceil, testValues.ceil, testIteration, seed, testType) && pass;
        pass = verifyTestValue("fma", expectedTestValues.fma, testValues.fma, testIteration, seed, testType) && pass;
        pass = verifyTestValue("ldexp", expectedTestValues.ldexp, testValues.ldexp, testIteration, seed, testType) && pass;
        pass = verifyTestValue("erf", expectedTestValues.erf, testValues.erf, testIteration, seed, testType) && pass;
        //pass = verifyTestValue("erfInv", expectedTestValues.erfInv, testValues.erfInv, testIteration, seed, testType) && pass;

        pass = verifyTestValue("floorVec", expectedTestValues.floorVec, testValues.floorVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("isnanVec", expectedTestValues.isnanVec, testValues.isnanVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("isinfVec", expectedTestValues.isinfVec, testValues.isinfVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("powVec", expectedTestValues.powVec, testValues.powVec, testIteration, seed, testType, 0.0001) && pass;
        pass = verifyTestValue("expVec", expectedTestValues.expVec, testValues.expVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("exp2Vec", expectedTestValues.exp2Vec, testValues.exp2Vec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("logVec", expectedTestValues.logVec, testValues.logVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("log2Vec", expectedTestValues.log2Vec, testValues.log2Vec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("absFVec", expectedTestValues.absFVec, testValues.absFVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("absIVec", expectedTestValues.absIVec, testValues.absIVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("sqrtVec", expectedTestValues.sqrtVec, testValues.sqrtVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("sinVec", expectedTestValues.sinVec, testValues.sinVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("cosVec", expectedTestValues.cosVec, testValues.cosVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("acosVec", expectedTestValues.acosVec, testValues.acosVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("modfVec", expectedTestValues.modfVec, testValues.modfVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("roundVec", expectedTestValues.roundVec, testValues.roundVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("roundEvenVec", expectedTestValues.roundEvenVec, testValues.roundEvenVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("truncVec", expectedTestValues.truncVec, testValues.truncVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("ceilVec", expectedTestValues.ceilVec, testValues.ceilVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("fmaVec", expectedTestValues.fmaVec, testValues.fmaVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("ldexp", expectedTestValues.ldexpVec, testValues.ldexpVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("tanVec", expectedTestValues.tanVec, testValues.tanVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("asinVec", expectedTestValues.asinVec, testValues.asinVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("atanVec", expectedTestValues.atanVec, testValues.atanVec, testIteration, seed, testType) && pass;
        //pass = verifyTestValue("sinhVec", expectedTestValues.sinhVec, testValues.sinhVec, testIteration, seed, testType) && pass;
        //pass = verifyTestValue("coshVec", expectedTestValues.coshVec, testValues.coshVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("tanhVec", expectedTestValues.tanhVec, testValues.tanhVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("asinhVec", expectedTestValues.asinhVec, testValues.asinhVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("acoshVec", expectedTestValues.acoshVec, testValues.acoshVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("atanhVec", expectedTestValues.atanhVec, testValues.atanhVec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("atan2Vec", expectedTestValues.atan2Vec, testValues.atan2Vec, testIteration, seed, testType) && pass;
        pass = verifyTestValue("erfVec", expectedTestValues.erfVec, testValues.erfVec, testIteration, seed, testType) && pass;
        //pass = verifyTestValue("erfInvVec", expectedTestValues.erfInvVec, testValues.erfInvVec, testIteration, seed, testType) && pass;

        // verify output of struct producing functions
        pass = verifyTestValue("modfStruct", expectedTestValues.modfStruct.fractionalPart, testValues.modfStruct.fractionalPart, testIteration, seed, testType) && pass;
        pass = verifyTestValue("modfStruct", expectedTestValues.modfStruct.wholeNumberPart, testValues.modfStruct.wholeNumberPart, testIteration, seed, testType) && pass;
        pass = verifyTestValue("modfStructVec", expectedTestValues.modfStructVec.fractionalPart, testValues.modfStructVec.fractionalPart, testIteration, seed, testType) && pass;
        pass = verifyTestValue("modfStructVec", expectedTestValues.modfStructVec.wholeNumberPart, testValues.modfStructVec.wholeNumberPart, testIteration, seed, testType) && pass;

        pass = verifyTestValue("frexpStruct", expectedTestValues.frexpStruct.significand, testValues.frexpStruct.significand, testIteration, seed, testType) && pass;
