...
class CClusteredRenderingBuilder extends IBuilder
{
	public CClusteredRenderingBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new CClusteredRenderingBuilder(_agent, _info)
}
