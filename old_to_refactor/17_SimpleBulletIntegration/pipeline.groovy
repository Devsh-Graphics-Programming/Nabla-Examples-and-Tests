...
class CSimpleBulletIntegrationBuilder extends IBuilder
{
	public CSimpleBulletIntegrationBuilder(Agent _agent, _info)
	{
		super(_agent, _info)
	}
...
{
	return new CSimpleBulletIntegrationBuilder(_agent, _info)
}
